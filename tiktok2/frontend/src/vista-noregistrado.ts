...
<vaadin-vertical-layout style="width: 100%; height: 100%;" id="vaadinVerticalLayout">
 <vaadin-horizontal-layout class="header" style="width: 100%; flex-basis: var(--lumo-size-l); flex-shrink: 0; background-color:white; " id="vaadinHorizontalLayout">
  ...
  <vaadin-button theme="primary error" style="align-self: center; color:white; width: 10%; flex-grow: 0; flex-shrink: 0;" id="vaadinButton1">
    Iniciar Sesión 
  </vaadin-button>
 </vaadin-horizontal-layout>
 <vaadin-horizontal-layout style="width: 100%; flex-grow: 1; flex-shrink: 0; flex-basis: auto;" id="vaadinHorizontalLayout1">
  <vaadin-vertical-layout class="sidebar" style="flex-grow: 0; flex-shrink: 0; height: 100%;" id="vaadinVerticalLayout2">
  ...
  <vaadin-vertical-layout theme="spacing" id="vaadinVerticalLayout3" style="flex-grow: 1; flex-shrink: 0;"></vaadin-vertical-layout>
 </vaadin-horizontal-layout>
</vaadin-vertical-layout>
`;
  }
